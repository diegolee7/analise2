 ...
 * @author Bruno
 */
public class TodasNotasSuperior extends javax.swing.JFrame {

    /**
     * Creates new form TodasNotasSuperior
     */
    public TodasNotasSuperior() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dados Avaliação");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TodasNotasSuperior.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TodasNotasSuperior().setVisible(true);
            }
        });
    }
